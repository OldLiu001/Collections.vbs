...
WScript.Echo "Test Clone & ToArray & Contains"
oStack.Push 1
oStack.Push 2
oStack.Push CreateObject("Scripting.Dictionary")
oStack.Push oStack
...
For i = 0 To UBound(arr1)
	WScript.Echo "index: " & i
	WScript.Echo TypeName(arr1(i)), TypeName(arr2(i))
	AssertEqual arr1(i), arr2(i)
Next
N = oStack.Count
For i = 0 To UBound(arr1)
	WScript.Echo "index2: " & i & " " & TypeName(arr2(i))
	AssertEqual oStack.Contains(arr2(i)), True
	AssertEqual oStack.Pop, oStack2.Pop
Next
WScript.Echo "Test Clone & ToArray & Contains passed"
WScript.Echo ""
